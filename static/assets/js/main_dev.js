...
function firstFunc() {
  document.getElementById("first-tariff").style.display = "block";
  document.getElementById("second-tariff").style.display = "none";
  document.getElementById("third-tariff").style.display = "none";
  document.getElementById("fBlock").style.backgroundColor = "#e1e1e1";
  document.getElementById("sBlock").style.backgroundColor = "white";
  document.getElementById("tBlock").style.backgroundColor = "white";
}
function secondFunc() {
  document.getElementById("first-tariff").style.display = "none";
  document.getElementById("second-tariff").style.display = "block";
  document.getElementById("third-tariff").style.display = "none";
  document.getElementById("fBlock").style.backgroundColor = "white";
  document.getElementById("sBlock").style.backgroundColor = "#e1e1e1";
  document.getElementById("tBlock").style.backgroundColor = "white";
}
function thirdFunc() {
  document.getElementById("first-tariff").style.display = "none";
  document.getElementById("second-tariff").style.display = "none";
  document.getElementById("third-tariff").style.display = "block";
  document.getElementById("fBlock").style.backgroundColor = "white";
  document.getElementById("sBlock").style.backgroundColor = "white";
  document.getElementById("tBlock").style.backgroundColor = "#e1e1e1";
}
const categorys = document.getElementById("categorys");
const btn = document.getElementById("bpm");
